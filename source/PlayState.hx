...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['PISS OFF YOU WANKA', 0.2], //From 0% to 19%
		['Cmon Man', 0.4], //From 20% to 39%
		['Oof', 0.5], //From 40% to 49%
		['Boi', 0.6], //From 50% to 59%
		['Ehhhh', 0.69], //From 60% to 68%
		['Noice', 0.7], //69%
		['Kewl', 0.8], //From 70% to 79%
		['Insert Michael Rosen Quote', 0.9], //From 80% to 89%
		['Boneriffic', 1], //From 90% to 99%
		['As Fine as Coras ass', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'street1': //Week 9
				var bg:BGSprite = new BGSprite('street1', -350, -280, 0.9, 0.9);
				add(bg);

			case 'street2': //Week 9
				var bg:BGSprite = new BGSprite('street2', -350, -280, 0.9, 0.9);
				add(bg);
